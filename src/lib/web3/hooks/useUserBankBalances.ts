...
export function useUserBankBalances(): UseQueryResult<TokenCoin[]> {
  ...
  const data = useMemo<TokenCoin[] | undefined>(() => {
    console.log('useUserChainDenomBalances', result.data);
    // console.log('useUserChainDenomBalances denoms', denoms)
    console.log('useUserChainDenomBalances tokenByDenom', tokenByDenom);
