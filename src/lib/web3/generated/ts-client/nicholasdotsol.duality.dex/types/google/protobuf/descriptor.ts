...
function createBaseDescriptorProto_ExtensionRange(): DescriptorProto_ExtensionRange {
  return { end: 0, options: undefined, start: 0 };
}
...
export const DescriptorProto_ReservedRange = {
  ...
  fromJSON(object: any): DescriptorProto_ReservedRange {
    return { end: isSet(object.end) ? Number(object.end) : 0, start: isSet(object.start) ? Number(object.start) : 0 };
  },
...
function createBaseEnumDescriptorProto(): EnumDescriptorProto {
  return { name: "", options: undefined, reservedName: [], reservedRange: [], value: [] };
}
...
function createBaseServiceDescriptorProto(): ServiceDescriptorProto {
  return { method: [], name: "", options: undefined };
}
...
function createBaseFieldOptions(): FieldOptions {
  return { ctype: 0, deprecated: false, jstype: 0, lazy: false, packed: false, uninterpretedOption: [], weak: false };
}
...
function createBaseUninterpretedOption_NamePart(): UninterpretedOption_NamePart {
  return { isExtension: false, namePart: "" };
}
...
function createBaseSourceCodeInfo_Location(): SourceCodeInfo_Location {
  return { leadingComments: "", leadingDetachedComments: [], path: [], span: [], trailingComments: "" };
}
...
function createBaseGeneratedCodeInfo_Annotation(): GeneratedCodeInfo_Annotation {
  return { begin: 0, end: 0, path: [], sourceFile: "" };
}
